...
// Es importante cambiar estos valores por los de tu entorno de producción/desarrollo.
define('DB_HOST', 'localhost');         // Host de la base de datos, comúnmente 'localhost'
